export const dict = {
  ...
  "provider.custom.field.apiKey.label": "Access key",
  "provider.custom.field.apiKey.placeholder": "Access key",
  ...
  "error.chain.checkConfig": "Check your GPD settings for correct provider/model names",
  ...
  "sidebar.help": "Help",
  "sidebar.resetKey": "Change access key",

  "settings.account.title": "Account",
  "settings.account.accessKey.title": "Access key",
  "settings.account.accessKey.description": "Remove your saved access key and return to the welcome screen.",
