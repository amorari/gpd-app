...
export const dict = {
  ...
  "error.chain.checkConfig": "GPD ayarlarındaki sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: GPD henüz MCP kimlik doğrulamasını desteklemiyor.',
