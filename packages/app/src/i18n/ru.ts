export const dict = {
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в настройки GPD",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что GPD пока не поддерживает MCP авторизацию.',
