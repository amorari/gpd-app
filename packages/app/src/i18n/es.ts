export const dict = {
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en la configuración de GPD",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, GPD no soporta autenticación MCP todavía.',
