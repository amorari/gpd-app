export const dict = {
  ...
  "error.chain.checkConfig": "Provjeri GPD postavke za ispravne provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: GPD još ne podržava MCP autentifikaciju.',
