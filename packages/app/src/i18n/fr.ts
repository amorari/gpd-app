export const dict = {
  ...
  "error.chain.checkConfig": "Vérifiez les paramètres de GPD pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'GPD ne supporte pas encore l'authentification MCP.",
