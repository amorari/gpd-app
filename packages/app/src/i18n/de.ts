...
export const dict = {
  ...
  "error.chain.checkConfig": "Überprüfen Sie die GPD-Einstellungen auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: GPD unterstützt noch keine MCP-Authentifizierung.',
  ...
  "session.review.noVcs.createGit.description":
    "Runs git init in {{path}}. This tracks changes, enables diffs and undo. No new folder is created — your existing files stay where they are.",
