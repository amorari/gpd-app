...
export const dict = {
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i GPD-innstillinger",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GPD ikke støtter MCP-autentisering ennå.',
