export const dict = {
  ...
  "error.chain.checkConfig": "Tjek GPD-indstillinger for korrekte udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, GPD understøtter ikke MCP-godkendelse endnu.',
