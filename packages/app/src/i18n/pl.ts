export const dict = {
  ...
  "error.chain.checkConfig": "Sprawdź ustawienia GPD pod kątem nazw dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GPD does not support MCP authentication yet.',
