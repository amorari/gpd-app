export const dict = {
  ...
  "error.chain.checkConfig": "ตรวจสอบชื่อผู้ให้บริการ/โมเดลในการตั้งค่า GPD",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า GPD ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
