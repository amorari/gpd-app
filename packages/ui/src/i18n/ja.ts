export const dict = {
  ...
  "ui.sessionReview.largeDiff.title": "変更が多すぎて一度に表示できません",
  ...
  "ui.fileMedia.state.error": "{{kind}}を読み込めませんでした。",
  "ui.fileMedia.state.unavailable": "{{kind}}は表示できません",
  "ui.fileMedia.binary.title": "テキスト以外のファイル",
  "ui.fileMedia.binary.description.path": "{{path}} はテキストとして表示できません。",
  "ui.fileMedia.binary.description.default": "テキスト以外のコンテンツ",
  ...
  "ui.sessionTurn.status.searchingCodebase": "プロジェクトを検索中",
  ...
  "ui.messagePart.compaction": "会話を要約しました",
  ...
  "ui.message.forkMessage": "新しい会話に分岐",
  ...
  "ui.toolErrorCard.failed": "うまくいきませんでした",
  ...
  "error.classified.rateLimit": "AI サービスのレート制限に達しました。少し待ってからもう一度お試しください。",
  "error.classified.auth": "サインインに失敗しました。設定でアクセスキーを確認してください。",
