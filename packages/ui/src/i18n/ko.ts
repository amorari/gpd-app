export const dict = {
  "ui.sessionReview.title": "대화 변경 사항",
  ...
  "ui.sessionReview.largeDiff.title": "변경 사항이 너무 많아 한 번에 표시할 수 없습니다",
  "ui.sessionReview.largeDiff.meta": "제한: {{limit}} 변경 줄. 현재: {{current}} 변경 줄.",
  "ui.sessionReview.largeDiff.renderAnyway": "그래도 표시",
  ...
  "ui.fileMedia.state.error": "{{kind}}을(를) 로드하지 못했습니다.",
  "ui.fileMedia.state.unavailable": "{{kind}} 사용 불가",
  "ui.fileMedia.binary.title": "텍스트가 아닌 파일",
  "ui.fileMedia.binary.description.path": "{{path}}은(는) 텍스트로 표시할 수 없습니다.",
  "ui.fileMedia.binary.description.default": "텍스트가 아닌 콘텐츠",
  ...
  "ui.sessionTurn.status.searchingCodebase": "프로젝트 검색 중",
  ...
  "ui.messagePart.compaction": "대화가 요약됨",
  ...
  "ui.message.forkMessage": "새 대화로 분기",
  ...
  "ui.toolErrorCard.failed": "성공하지 못함",
  ...
  "error.classified.rateLimit": "AI 서비스의 속도 제한에 도달했습니다. 잠시 기다린 후 다시 시도해 주세요.",
  "error.classified.auth": "로그인에 실패했습니다. 설정에서 액세스 키를 확인하세요.",
  ...
  "error.classified.invalidRequest": "AI 서비스가 요청을 거부했습니다.",
