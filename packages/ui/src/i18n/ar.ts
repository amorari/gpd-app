export const dict = {
  "ui.sessionReview.title": "تغييرات المحادثة",
  ...
  "ui.sessionReview.largeDiff.title": "تغييرات كثيرة جدًا لعرضها دفعة واحدة",
  ...
  "ui.fileMedia.state.error": "تعذّر تحميل {{kind}}.",
  "ui.fileMedia.state.unavailable": "{{kind}} غير متوفر",
  "ui.fileMedia.binary.title": "ملف غير نصي",
  "ui.fileMedia.binary.description.path": "{{path}} لا يمكن عرضه كنص.",
  "ui.fileMedia.binary.description.default": "محتوى غير نصي",
  ...
  "ui.sessionTurn.status.searchingCodebase": "البحث في مشروعك",
  ...
  "ui.messagePart.compaction": "تم تلخيص المحادثة",
  ...
  "ui.tool.read": "قراءة ملف",
  "ui.tool.loaded": "تم التحميل",
  "ui.tool.list": "قائمة الملفات",
  "ui.tool.glob": "Finding files",
  "ui.tool.grep": "البحث داخل الملفات",
  "ui.tool.webfetch": "Fetching page",
  "ui.tool.websearch": "البحث في الويب",
  "ui.tool.codesearch": "البحث في الكود عبر الإنترنت",
  ...
  "ui.tool.agent": "مساعد: {{type}}",
  "ui.tool.agent.default": "مساعد",
  ...
  "ui.message.forkMessage": "تفرّع إلى محادثة جديدة",
  ...
  "ui.tool.task": "مهمة فرعية",
  "ui.tool.skill": "مهارة",
  "ui.basicTool.called": "تم استدعاء `{{tool}}`",
  "ui.toolErrorCard.failed": "لم يعمل",
