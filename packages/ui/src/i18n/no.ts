...
export const dict: Record<Keys, string> = {
  "ui.sessionReview.title": "Samtaleendringer",
  ...
  "ui.sessionReview.largeDiff.title": "For mange endringer til å vise på én gang",
  "ui.sessionReview.largeDiff.meta": "Grense: {{limit}} endrede linjer. Nåværende: {{current}} endrede linjer.",
  "ui.sessionReview.largeDiff.renderAnyway": "Vis likevel",
  ...
  "ui.fileMedia.state.error": "Kunne ikke laste inn {{kind}}.",
  "ui.fileMedia.state.unavailable": "Ikke tilgjengelig: {{kind}}",
  "ui.fileMedia.binary.title": "Ikke-tekstfil",
  "ui.fileMedia.binary.description.path": "{{path}} kan ikke vises som tekst.",
  "ui.fileMedia.binary.description.default": "Innhold uten tekst",
  ...
  "ui.sessionTurn.status.searchingCodebase": "Søker i prosjektet ditt",
  ...
  "ui.messagePart.compaction": "Samtale oppsummert",
  ...
  "ui.tool.read": "Leser fil",
  "ui.tool.loaded": "Lastet",
  "ui.tool.list": "Lister filer",
  "ui.tool.glob": "Finding files",
  "ui.tool.grep": "Søker i filer",
  "ui.tool.webfetch": "Fetching page",
  "ui.tool.websearch": "Søker på nettet",
  "ui.tool.codesearch": "Søker i kode på nettet",
  ...
  "ui.message.forkMessage": "Forgren til ny samtale",
  ...
  "ui.tool.task": "Deloppgave",
  "ui.tool.skill": "Ferdighet",
  "ui.basicTool.called": "Kalte `{{tool}}`",
  "ui.toolErrorCard.failed": "Virket ikke",
