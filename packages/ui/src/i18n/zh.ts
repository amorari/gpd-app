...
export const dict = {
  ...
  "ui.sessionReview.largeDiff.title": "变更过多，无法一次全部显示",
  "ui.sessionReview.largeDiff.meta": "限制：{{limit}} 行变更。当前：{{current}} 行变更。",
  "ui.sessionReview.largeDiff.renderAnyway": "仍然显示",
  ...
  "ui.fileMedia.state.error": "无法加载{{kind}}。",
  "ui.fileMedia.state.unavailable": "{{kind}}不可预览",
  "ui.fileMedia.binary.title": "非文本文件",
  "ui.fileMedia.binary.description.path": "{{path}} 无法以文本形式显示。",
  "ui.fileMedia.binary.description.default": "非文本内容",
  ...
  "ui.sessionTurn.status.searchingCodebase": "正在搜索您的项目",
  ...
  "ui.messagePart.compaction": "对话已总结",
  ...
  "error.classified.rateLimit": "AI 服务的速率限制已触发。请稍候再试。",
  "error.classified.auth": "登录失败。请在设置中检查您的访问密钥。",
