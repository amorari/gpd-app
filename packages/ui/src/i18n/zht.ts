...
export const dict = {
  ...
  "ui.sessionReview.largeDiff.title": "變更過多，無法一次全部顯示",
  "ui.sessionReview.largeDiff.meta": "限制：{{limit}} 行變更。目前：{{current}} 行變更。",
  "ui.sessionReview.largeDiff.renderAnyway": "仍然顯示",
  ...
  "ui.fileMedia.state.error": "無法載入{{kind}}。",
  "ui.fileMedia.state.unavailable": "{{kind}}無法預覽",
  "ui.fileMedia.binary.title": "非文字檔案",
  "ui.fileMedia.binary.description.path": "{{path}} 無法以文字形式顯示。",
  "ui.fileMedia.binary.description.default": "非文字內容",
  ...
  "ui.sessionTurn.status.searchingCodebase": "正在搜尋您的專案",
  ...
  "ui.messagePart.compaction": "對話已總結",
