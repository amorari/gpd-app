export const dict = {
  ...
  "desktop.menu.installCli": "명령줄 도구 설치...",
  ...
  "desktop.updater.none.message": "이미 최신 버전의 GPD를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "GPD {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
  "desktop.updater.installFailed.title": "업데이트 실패",
  "desktop.updater.installFailed.message": "업데이트를 설치하지 못했습니다",

  "desktop.cli.installed.title": "명령줄 도구가 설치됨",
  "desktop.cli.installed.message":
    "{{path}}에 설치되었습니다\n\n명령 프롬프트를 다시 시작하여 'gpd' 명령을 사용하세요.",
  "desktop.cli.failed.title": "설치 실패",
  "desktop.cli.failed.message": "명령줄 도구를 설치하지 못했습니다: {{error}}",
  ...
  "desktop.menu.file.newSession": "새 대화",
  "desktop.menu.file.openProject": "프로젝트 열기...",
  "desktop.menu.view.toggleSidebar": "사이드바 전환",
  "desktop.menu.view.toggleTerminal": "명령 프롬프트 전환",
  "desktop.menu.view.toggleFileTree": "파일 트리 전환",
  "desktop.menu.view.back": "뒤로",
  "desktop.menu.view.forward": "앞으로",
  "desktop.menu.view.previousSession": "이전 대화",
  "desktop.menu.view.nextSession": "다음 대화",
  "desktop.menu.help.documentation": "GPD 문서",
  "desktop.menu.help.supportForum": "지원 포럼",
  "desktop.menu.help.shareFeedback": "피드백 공유",
  "desktop.menu.help.reportBug": "버그 신고",
  "desktop.cli.error.unsupportedPlatform": "명령줄 도구 설치 프로그램은 macOS 및 Linux에서만 지원됩니다.",
  "desktop.cli.error.sidecarMissing": "GPD 헬퍼 프로그램이 누락되었습니다. 데스크톱 앱을 다시 설치해 보세요.",
  "desktop.cli.error.scriptWriteFailed": "설치 스크립트를 준비하지 못했습니다.",
  "desktop.cli.error.scriptPermissionFailed": "설치 프로그램을 실행 가능하게 만들지 못했습니다.",
  "desktop.cli.error.scriptRunFailed": "설치 스크립트를 실행하지 못했습니다.",
  "desktop.cli.error.scriptFailed": "설치 프로그램이 실패했습니다.",
  "desktop.cli.error.installPathUnknown": "명령줄 도구가 어디에 설치되었는지 확인할 수 없습니다.",
  "desktop.cli.error.unknown": "알 수 없는 설치 오류",
  "desktop.loading.status.initial": "잠시만 기다려 주세요...",
  "desktop.loading.status.done": "모두 완료되었습니다",
  "desktop.loading.status.migrating": "데이터를 업데이트하는 중",
  "desktop.loading.status.waiting": "이 작업은 몇 분 정도 걸릴 수 있습니다",
  "desktop.loading.progressAria": "데이터 업데이트 진행률",
  "desktop.server.local": "이 컴퓨터",
}
