export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 GPD",
  ...
  "desktop.updater.downloaded.prompt": "已下载 GPD {{version}} 版本，是否安装并重启？",
  "desktop.updater.installFailed.title": "更新失败",
  "desktop.updater.installFailed.message": "无法安装更新",

  "desktop.cli.installed.title": "命令行工具已安装",
  "desktop.cli.installed.message": "已安装到 {{path}}\n\n重启命令提示窗以使用 'gpd' 命令。",
  "desktop.cli.failed.title": "安装失败",
  "desktop.cli.failed.message": "无法安装命令行工具：{{error}}",
  ...
  "desktop.menu.file.newSession": "新建对话",
  "desktop.menu.file.openProject": "打开项目...",
  "desktop.menu.view.toggleSidebar": "切换侧边栏",
  "desktop.menu.view.toggleTerminal": "切换命令提示窗",
  "desktop.menu.view.toggleFileTree": "切换文件树",
  "desktop.menu.view.back": "后退",
  "desktop.menu.view.forward": "前进",
  "desktop.menu.view.previousSession": "上一个对话",
  "desktop.menu.view.nextSession": "下一个对话",
  "desktop.menu.help.documentation": "GPD 文档",
  "desktop.menu.help.supportForum": "支持论坛",
  "desktop.menu.help.shareFeedback": "分享反馈",
  "desktop.menu.help.reportBug": "报告错误",
  "desktop.cli.error.unsupportedPlatform": "命令行工具安装程序仅支持 macOS 和 Linux。",
  "desktop.cli.error.sidecarMissing": "GPD 辅助程序缺失。请尝试重新安装桌面应用程序。",
  "desktop.cli.error.scriptWriteFailed": "无法准备安装脚本。",
  "desktop.cli.error.scriptPermissionFailed": "无法将安装程序设为可执行。",
  "desktop.cli.error.scriptRunFailed": "无法运行安装脚本。",
  "desktop.cli.error.scriptFailed": "安装程序失败。",
  "desktop.cli.error.installPathUnknown": "无法确定命令行工具的安装位置。",
  "desktop.cli.error.unknown": "未知的安装错误",
  "desktop.loading.status.initial": "稍等片刻...",
  "desktop.loading.status.done": "全部完成",
  "desktop.loading.status.migrating": "正在更新您的数据",
  "desktop.loading.status.waiting": "这可能需要几分钟",
  "desktop.loading.progressAria": "数据更新进度",
  "desktop.server.local": "本机",
}
